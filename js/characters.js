...
const SPEC = {
  ...
  dragon: {
    fur: 0x7FD8B8, hs: [1, 1, 1.02], orb: true,
    head: [
      // 가지 친 사슴뿔
      ...pair({ g: ['cone', 0.04, 0.22, 8], c: 0xF4E2B0, p: [0.10, 0.85, -0.06], r: [-0.35, 0, -0.15] }),
      ...pair({ g: ['cone', 0.024, 0.1, 6], c: 0xF4E2B0, p: [0.165, 0.86, -0.04], r: [-0.2, 0, -1.0] }),
      // 뒤통수의 산호색 갈기 가시
      { g: ['cone', 0.055, 0.15, 6], c: 0xFF7B5C, r: [-0.8, 0, 0], p: [0, 0.83, -0.13] },
      { g: ['cone', 0.055, 0.15, 6], c: 0xFF7B5C, r: [-1.3, 0, 0], p: [0, 0.73, -0.23] },
      { g: ['cone', 0.05, 0.13, 6], c: 0xFF7B5C, r: [-1.75, 0, 0], p: [0, 0.6, -0.27] },
      // 주둥이·콧구멍·수염
      { g: ['sphere', 0.13], c: 0xF6EBD2, s: [1.05, 0.7, 1.2], p: [0, 0.48, 0.22] },
      ...pair({ g: ['sphere', 0.02, 8, 6], c: 0x2F6E5A, p: [0.045, 0.51, 0.36] }),
      { g: ['torus', 0.09, 0.013, 4, 10, 1.4], c: 0xFF7B5C, r: [0, 0, Math.PI / 2], p: [-0.12, 0.39, 0.31] },
      { g: ['torus', 0.09, 0.013, 4, 10, 1.4], c: 0xFF7B5C, r: [0, Math.PI, Math.PI / 2], p: [0.12, 0.39, 0.31] },
    ],
    tail: {
      parts: [{ g: ['coneZ', 0.07, 0.30, 10], c: 0x7FD8B8 }, { g: ['sphere', 0.03, 8, 6], c: 0xFF7B5C, p: [0, 0, -0.30] }],
      pivot: [0, 0.22, -0.27], rx: 0.3,
    },
    gait: { h: 0.7, sq: 0.5, glide: true },
  },
};
...
export function createPieces(ctx, opts = {}) {
  ...
  function quirk() {
    ...
    switch (r.species) {
      ...
      case 'dragon': gest(r, 'glow', 800); gest(r, 'wag', 600, { amp: 0.35, n: 2 }); break;
    }
  }
